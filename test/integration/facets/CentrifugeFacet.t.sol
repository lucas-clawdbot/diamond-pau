...
contract Controller_CentrifugeFacet_Tests is Integration_TestBase {
    ...
    function test_getCancelDepositRateLimitKey() external {
        ...
        assertEq(controller.getCancelDepositRateLimitKey(token), makeAddressKey(keyPrefix, token));
    }
    ...
    function test_getClaimCancelDepositRateLimitKey() external {
        ...
        assertEq(controller.getClaimCancelDepositRateLimitKey(token), makeAddressKey(keyPrefix, token));
    }
    ...
    function test_getCancelRedeemRateLimitKey() external {
        ...
        assertEq(controller.getCancelRedeemRateLimitKey(token), makeAddressKey(keyPrefix, token));
    }
    ...
    function test_getClaimCancelRedeemRateLimitKey() external {
        ...
        assertEq(controller.getClaimCancelRedeemRateLimitKey(token), makeAddressKey(keyPrefix, token));
    }
